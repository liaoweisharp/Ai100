...
$(function () {
    ...
    TC_json.$btnSaveTesterAnswers.click(function () {
        ...
        $excuteWS("~TestWS.TestResult_saveTesterAnswersResult", { testResultWrapper: getTestResultWrapper(),  testResultQuestions: _testResultQuestionWrappers, user: get_simpleUser() }, function (r) {
    ...
    U(function () {
        ...
        if (TC_json.$timer.length != 0 && TC_json.$timer.is(":visible")) {
            $(":button.tc_button").prop("disabled", "disabled").removeClass().addClass("tc_button_disabled");
        }
        ...
        $excuteWS("~TestWS.QuestionInfo_getTestDetail", json_data, function (r2) {
            ...
            if (questions) {
                ...
                if (TC_json.urlParams.type != "2") {
                    ...
                    setTimeout(function () {
                        if (get_roleId() == "1") {
                            $(":button.tc_button,:button.tc_button_disabled").removeProp("disabled").removeClass().addClass("tc_button");
                        } else {
                            TC_json.$btnExitTest.removeProp("disabled").removeClass().addClass("tc_button");
                        }
