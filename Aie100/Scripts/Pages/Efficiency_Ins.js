...
function html_body(data){
    ...
    str.push(String.format("<td class='td2 order' ordername='{0}' onclick=\"reOrder('{0}')\">作业完成分{1}</td>", "compRate", _getOrderImg("compRate")));
    str.push(String.format("<td class='td2 order' ordername='{0}' onclick=\"reOrder('{0}')\">作业成绩分{1}</td>", "compScore", _getOrderImg("compScore")));
    str.push(String.format("<td class='td2 order' ordername='{0}' onclick=\"reOrder('{0}')\">作业效率分{1}</td>", "compEffice", _getOrderImg("compEffice")));
    str.push(String.format("<td class='td2 order' ordername='{0}' onclick=\"reOrder('{0}')\">知识掌握分{1}</td>", "knowledgeLevel", _getOrderImg("knowledgeLevel")));
    str.push(String.format("<td class='td2 order' ordername='{0}' onclick=\"reOrder('{0}')\">综合评估分{1}</td>", "studyEffice", _getOrderImg("studyEffice")));
