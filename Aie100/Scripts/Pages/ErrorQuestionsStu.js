...
var json_errorq = { urlParams: null, $divErrQuestionList: null, $ddlIncorreceBase: null, $txtStartDate: null, $txtEndDate: null, $spViewByDateRange: null, errorQuestions: null, questionIds: [] };
...
function getQuestionError() {
    ...
    if (json_errorq.urlParams.userId) {
        $excuteWS("~ErrorQuestionWS.questionErrorUserByUserId", { userId: json_errorq.urlParams.userId, correceBase: json_errorq.$ddlIncorreceBase.val(), startDate: _startDate, endDate: _endDate, userExtend: get_simpleUser() }, function (r) {
    ...
    } else if (json_errorq.urlParams.structureId) {
        $excuteWS("~ErrorQuestionWS.questionErrorUserByStructureId", { structureId: json_errorq.urlParams.structureId, userId: get_userId(), correceBase: json_errorq.$ddlIncorreceBase.val(), startDate: _startDate, endDate: _endDate, userExtend: get_simpleUser() }, function (r) {
        ...
        $excuteWS("~ErrorQuestionWS.questionErrorUserByLoIds", { pointingLoIds: [json_errorq.urlParams.pointingLoId], userId: get_userId(), correceBase: json_errorq.$ddlIncorreceBase.val(), startDate: _startDate, endDate: _endDate, userExtend: get_simpleUser() }, function (r) {
