...
public partial class Student_LearningCenter : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            (this.Master.FindControl("spEfficiency") as HtmlGenericControl).InnerHtml = "<span location=\"../Student/Efficiency.aspx?sectionId=" + sectionId + "\">效率排行榜</span>";
