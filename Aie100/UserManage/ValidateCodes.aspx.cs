...
public partial class Registration_ValidateCodes : System.Web.UI.Page
{
    ...
    {
        string allChar = "1,2,3,4,5,6,7,8,9,A,B,C,D,E,F,G,H,K,K,J,K,M,N,P,Q,R,S,T,U,W,X,Y,Z";
    ...
    {
        string allChar = "1,2,3,4,5,6,7,8,9,A,B,C,D,E,F,K,K,G,H,J,K,M,N,P,Q,R,S,T,U,W,X,Y,Z";
        string[] allCharArray = allChar.Split(',');
        string RandomCode = "";
        int temp = -1;
    ...
    private void CreateImage(string checkCode)
    {
        ...
        for (int i = 0; i < 3; i++)
        {
            int left = rand.Next(image.Height * 2);
            int right = rand.Next(image.Height * 2);
            g.DrawLine(blackPen, 0, left, image.Width, right);
        }
