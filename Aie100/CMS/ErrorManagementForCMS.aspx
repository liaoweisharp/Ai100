<%@ Page Language="C#" AutoEventWireup="true" Title="Error Management" MasterPageFile="~/CMS/Master/cms.master"
    CodeFile="ErrorManagementForCMS.aspx.cs" Inherits="ContentManagementSystem_ErrorManagementForCMS" %>
<%--
<%@ Register Src="~/CMS/UserControl/ErrorManageControl.ascx"
    TagName="ErrorManage" TagPrefix="uc1" %>--%>
