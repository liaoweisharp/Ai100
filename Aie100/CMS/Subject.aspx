<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Subject.aspx.cs" Inherits="CMS_Subject" 
    MasterPageFile="~/CMS/Master/cms.master"%>

<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="head">
    <script src="Scripts/Subject.js?version=1127" type="text/javascript"></script>
</asp:Content>
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder">
    ...
    <div class="cms_contentbox" style="display:none">
        <table class="cms_datatable">
            <tr><th width="300">学科类别</th><th width="300">学科名称</th><th width="100">序号</th><th width="100">是否可用</th><th>操作</th></tr>
        </table>
    </div>
</asp:Content>
