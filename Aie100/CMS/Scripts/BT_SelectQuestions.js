...
function onConfirmAddQuestion() {
    ...
    if (mQuestionIds.length > 0) {
        //返回母题对应的子题
        $excuteWS("~CmsWS.getSubQuestionListByIds", { questionIds: mQuestionIds, qpvSeedIds: qpvSeedIds, usersExtendWrapper: SimpleUser }, function (subQuestions) {
    ...
    if (questionIdArray.length > 0) {
        ...
        $("div.pagination").html("").pagination(questionIdArray.length, {
            ...
            callback: function (page_index, o) {
                ...
                $excuteWS("~CmsWS.getQuestionFCList", { questionIds: questionIds, usersExtendWrapper: SimpleUser }, fn, null, null);
            }
        });
    }
}