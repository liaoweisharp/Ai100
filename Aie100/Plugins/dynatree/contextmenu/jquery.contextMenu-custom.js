...
//2014-03-21 heyaohong
//            Add a callback queryShowMenu(menu, el), called before the menu is displayed

if(jQuery)( function() {
	$.extend($.fn, {
		
	    contextMenu: function (o, callback, queryShowMenu) {
			// Defaults
...
//						e.stopPropagation();
						...
						if( evt.button == 2 ) {
						    ...
						    //Query show the menu
							if (queryShowMenu) queryShowMenu($(menu), $(srcElement));
